import { Box, Button, FormControl, FormLabel, Grid, Input, useColorModeValue } from "@chakra-ui/react";
...
export default function AddCarForm(){
    ...
    return (
        ...
        <Button type='submit' ml={64} colorScheme='gray' size='lg' >Add car</Button>
      </Box>
    )
}